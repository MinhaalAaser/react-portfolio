...
class Blog extends Component {
  ...
  handleDeleteClick(blog) {
    ...
    .catch(error => {
      console.log('error from delete click', error)
    })
  }
  ...
  getBlogItems() {
    ...
    axios.get(`https://minhaalaaser.devcamp.space/portfolio/portfolio_blogs?page=${this.state.currentPage}`, { withCredentials : true })
    .then(response => {
      this.setState({
